...
import { SparklineData } from '../../../data/data-controllers/_grid-data-controller';
export declare class GridColumnPainter {
    ...
    static renderSparkline(name: string, showStartEndValues: boolean, parentContainer: HTMLElement, sparklineData: SparklineData): void;
