...
import { DashboardExportFormat } from '../../common/extensions/export-extension';
...
import { ConstraintsEx, ISize } from '../layout/_utils.layout';
import { DashboardItemCaptionToolbarOptions, ViewerToolbarItem } from '../widgets/caption-toolbar/caption-toolbar-options';
import { CaptionToolbar, ItemCaptionToolbarViewOptions } from '../widgets/caption-toolbar/_caption-toolbar-base';
import { GridClientState } from './data-grid-item/_data-grid-item';
import { IItemLoadingElement } from './elements/_item-loading';
import { MapClientState } from './_map-item';
...
export declare abstract class baseItem {
    ...
    customSelectedTuples: itemDataTupleValues[];
    ...
    getSelectedTuples(): itemDataTupleValues[];
    ...
    protected _selectTuples(tuplesToSelect: itemDataTupleValues[], unaffectedTuples: itemDataTupleValues[], isSelect: boolean): void;
    ...
    updateClientState(clientState: MapClientState | GridClientState): void;
    ...
    getConstraints(includeBorders: any): ConstraintsEx;
    getOffset(): ISize;
    ...
    protected _updateClientStateUnsafe(clientState: MapClientState | GridClientState): void;
    ...
    protected _clickAction(tuple: itemDataTupleValues): void;
    ...
    protected _onClientStateUpdate(clientState: MapClientState | GridClientState): void;
