/**
* DevExpress Dashboard (_caption-toolbar-css-classes.d.ts)
* Version:  22.2.4
...
export declare function _convertToExportFormat(exportIcon: any): DashboardExportFormat;
