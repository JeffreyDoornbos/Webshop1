...
.dx-dashboard-datasource-browser-wrapper .dx-dashboard-form-right-column .dx-dashboard-datasource-tree-wrapper .dx-dashboard-datasource-browser-tree .dx-treelist .dx-treelist-item.dx-treelist-item-selected {
  background-color: rgba(156, 99, 255, 0.4588235294);
  color: #f5f6f7;
}
...
.dx-dashboard-datasource-browser-wrapper .dx-dashboard-form-right-column .dx-dashboard-datasource-tree-wrapper .dx-dashboard-datasource-browser-tree .dx-treelist .dx-treelist-item:hover:not(.dx-dashboard-treelist-item-disabled) {
  background-color: rgba(158, 158, 197, 0.3019607843);
  color: #f5f6f7;
}
...
.dx-dashboard-loading-container .dx-dashboard-surface .dx-dashboard-layout-state.dx-dashboard-layout-state-empty svg use {
  fill: rgba(245, 246, 247, 0.65);
  color: rgba(245, 246, 247, 0.65);
  opacity: 0.35;
}
...
.dx-dashboard-loading-container .dx-dashboard-surface .dx-dashboard-layout-state.dx-dashboard-layout-state-error svg use {
  fill: #d9534f;
  color: #d9534f;
}
...
.dx-dashboard-item-menu .dx-dashboard-designer-menu-item.dx-dashboard-item-menu-toggle svg use {
...
.dx-dashboard-data-binding-surface .dx-dashboard-panel-header {
  right: 2px;
}
...
.dx-dashboard-hierarchical-group dx-dashboard-data-item-link .dx-button-mode-contained.dx-buttongroup-item::before {
  ...
  border-color: rgba(158, 158, 197, 0.3019607843) transparent;
  display: block;
  width: 0;
  z-index: 1;
}
...
.dx-dashboard-toolbar-extension .dx-dashboard-toolbar-separator .dx-toolbar-item-content {
  ...
  position: absolute;
  height: 100%;
  border-left: 1px solid rgba(158, 158, 197, 0.3019607843);
}
...
.dx-dashboard-loading-container .dx-texteditor-buttons-container .dx-icon.dx-icon-clear:before {
  content: " ";
  height: 100%;
  display: block;
...
.dx-dashboard-loading-container .dx-dashboard-settings-form .dx-clear-button-area {
  width: 30px;
}
.dx-dashboard-widget-container .dx-dashboard-settings-form .dx-show-clear-button .dx-icon-clear,
.dx-dashboard-loading-container .dx-dashboard-settings-form .dx-show-clear-button .dx-icon-clear {
  margin-top: -17px;
  width: 34px;
  height: 34px;
...
.dx-dashboard-loading-container .dx-dashboard-settings-form .dx-dropdowneditor-icon {
  width: 32px;
  font-size: 18px;
  line-height: 18px;
}
.dx-dashboard-widget-container .dx-dashboard-settings-form .dx-dropdowneditor-icon:before,
.dx-dashboard-loading-container .dx-dashboard-settings-form .dx-dropdowneditor-icon:before {
  width: 18px;
  margin-top: -9px;
  margin-left: -9px;
}
.dx-dashboard-widget-container .dx-dashboard-settings-form .dx-dropdowneditor-button,
.dx-dashboard-loading-container .dx-dashboard-settings-form .dx-dropdowneditor-button {
  width: 34px;
}
.dx-dashboard-widget-container .dx-dashboard-settings-form .dx-tag-content,
.dx-dashboard-loading-container .dx-dashboard-settings-form .dx-tag-content {
  margin: 4px 0 0 4px;
  padding: 3px 25px 4px 6px;
  min-width: 40px;
}
.dx-dashboard-widget-container .dx-dashboard-settings-form .dx-tag-remove-button,
.dx-dashboard-loading-container .dx-dashboard-settings-form .dx-tag-remove-button {
  width: 25px;
  height: 100%;
}
.dx-dashboard-widget-container .dx-dashboard-settings-form .dx-tag-remove-button:before,
.dx-dashboard-loading-container .dx-dashboard-settings-form .dx-tag-remove-button:before {
  right: 9px;
  margin-top: -5px;
  width: 3px;
  height: 11px;
...
.dx-dashboard-loading-container .dx-dashboard-settings-form .dx-tag-remove-button:after {
  right: 5px;
  margin-top: -1px;
  width: 11px;
  height: 3px;
...
.dx-dashboard-loading-container .dx-dashboard-settings-form .dx-list-item .dx-list-item-content {
  padding: 10px 10px;
}
...
.dx-dashboard-toolbar-extension .dx-toolbar .dx-toolbar-item.dx-dashboard-undo-redo-button .dx-button .dx-button-content svg use {
  color: rgba(245, 246, 247, 0.65);
}
.dx-dashboard-toolbar-extension .dx-toolbar .dx-toolbar-item.dx-dashboard-undo-redo-button .dx-button .dx-button-content.dx-state-disabled svg use {
  color: rgba(245, 246, 247, 0.3);
}
...
.dx-dashboard-viewer .dx-datagrid-rowsview .dx-selection.dx-row:not(.dx-row-focused) > td, .dx-dashboard-viewer .dx-datagrid-rowsview .dx-selection.dx-row:not(.dx-row-focused):hover > td, .dx-dashboard-viewer .dx-datagrid-rowsview .dx-selection.dx-row:not(.dx-row-focused) > tr > td, .dx-dashboard-viewer .dx-datagrid-rowsview .dx-selection.dx-row:not(.dx-row-focused):hover > tr > td, .dx-dashboard-viewer .dx-datagrid-rowsview .dx-selection.dx-row:hover > td {
  background-color: #353544;
  color: #f5f6f7;
}
.dx-dashboard-viewer .dx-datagrid-rowsview .dx-selection.dx-row:not(.dx-row-focused) > td .dx-link, .dx-dashboard-viewer .dx-datagrid-rowsview .dx-selection.dx-row:not(.dx-row-focused):hover > td .dx-link, .dx-dashboard-viewer .dx-datagrid-rowsview .dx-selection.dx-row:not(.dx-row-focused) > tr > td .dx-link, .dx-dashboard-viewer .dx-datagrid-rowsview .dx-selection.dx-row:not(.dx-row-focused):hover > tr > td .dx-link, .dx-dashboard-viewer .dx-datagrid-rowsview .dx-selection.dx-row:hover > td .dx-link {
  color: inherit;
}
.dx-dashboard-viewer .dx-datagrid-rowsview .dx-selection.dx-row:not(.dx-row-focused):not(.dx-row-lines) > td, .dx-dashboard-viewer .dx-datagrid-rowsview .dx-selection.dx-row:not(.dx-row-focused):hover:not(.dx-row-lines) > td, .dx-dashboard-viewer .dx-datagrid-rowsview .dx-selection.dx-row:not(.dx-row-focused).dx-row-lines > td, .dx-dashboard-viewer .dx-datagrid-rowsview .dx-selection.dx-row:not(.dx-row-focused):hover.dx-row-lines > td, .dx-dashboard-viewer .dx-datagrid-rowsview .dx-selection.dx-row:not(.dx-row-focused).dx-row-lines > tr > td, .dx-dashboard-viewer .dx-datagrid-rowsview .dx-selection.dx-row:not(.dx-row-focused):hover.dx-row-lines > tr > td {
  border-bottom-color: #353544;
  border-top-color: #353544;
}
.dx-dashboard-viewer .dx-datagrid-rowsview .dx-selection.dx-row.dx-column-lines > td, .dx-dashboard-viewer .dx-datagrid-rowsview .dx-selection.dx-row:hover.dx-column-lines > td, .dx-dashboard-viewer .dx-datagrid-rowsview .dx-selection.dx-row.dx-column-lines > tr > td, .dx-dashboard-viewer .dx-datagrid-rowsview .dx-selection.dx-row:hover.dx-column-lines > tr > td {
  border-left-color: #353544;
  border-right-color: #353544;
}
...
.dx-dashboard-settings-form-content .dx-dashboard-properties .dx-editor {
  padding-bottom: 18px;
}
...
.dx-dashboard-hierarchical-group dx-dashboard-data-item-link:last-of-type .dx-button-mode-contained.dx-buttongroup-item {
  border-bottom: 1px solid rgba(158, 158, 197, 0.3019607843);
...
.dx-dashboard-datasources-list .dx-list-item .dx-dashboard-datasource-item .dx-dashboard-datasource-description {
  height: 40px;
  line-height: 40px;
  padding: 0 10px;
  font-size: 12px;
}
.dx-dashboard-datasources-list .dx-list-item .dx-dashboard-datasource-item .dx-dashboard-datasource-icons {
  padding-right: 7px;
  margin-left: auto;
}
...
.dx-dashboard-designer-toolbar .dx-dashboard-toolbar-button-group .dx-buttongroup.dx-dashboard-button-with-icon svg use {
  color: rgba(245, 246, 247, 0.8);
}
.dx-dashboard-designer-toolbar .dx-dashboard-toolbar-button-group .dx-buttongroup.dx-dashboard-button-with-icon.dx-state-disabled svg use {
  color: rgba(245, 246, 247, 0.3);
}
...
.dx-dashboard-designer-toolbar .dx-dashboard-toolbar-button-group .dx-buttongroup.dx-dashboard-button-with-icon .dx-item-selected svg use {
  color: rgba(245, 246, 247, 0.8);
  fill: #9c63ff;
}
...
.dx-dashboard-designer-toolbar .dx-dashboard-toolbar-spinedit .dx-numberbox {
  height: 30px;
}
.dx-dashboard-designer-toolbar .dx-dashboard-toolbar-spinedit .dx-numberbox .dx-texteditor-input {
  font-size: 13px;
}
