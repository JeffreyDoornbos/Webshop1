...
*/
import { IModelSerializer, ModelSerializer } from '@devexpress/analytics-core/analytics-utils';
import * as ko from 'knockout';
import { itemDataManager } from '../../data/item-data/internal/_item-data-manager';
import { ItemDataAxisName, ItemDataAxisPoint, ItemDataAxisPointTuple } from '../../data/item-data/item-data-definitions';
...
export declare abstract class DataDashboardItem extends DashboardItem implements IDataItemProvider, IMasterFilterItemsProvider, IColorSignaturesProvider, IDataSourceConsumer {
    ...
    protected static _addColoringMeta: (links: Array<DataItemLink>) => void;
    static _createFormatRule(item: DataDashboardItem, formatRuleJSON: any, serializer?: IModelSerializer): DashboardItemFormatRule;
    ...
    _dataManager: ko.Observable<itemDataManager>;
    _drillDownValues: ko.ObservableArray<PrimitiveType>;
    _clientState: ko.Observable<GridClientState | MapClientState>;
    ...
    get _interactivityDimensions(): Array<Dimension>;
    get _dimensions(): Array<Dimension>;
    get _measures(): Array<Measure>;
    get _uniqueDataItems(): Array<DataItem>;
    _isExcludingAllFilter: ko.Computed<boolean>;
    protected get _multiData(): itemData;
    ...
    protected _getPointsByDimension(dimensionId: string, axisName: ItemDataAxisName): ItemDataAxisPoint[];
    ...
    _getColoringSignatureOnCurrentDrillDownLevel(): ColorSchemeDefinition;
    _getColoringSignatureBase(coloredDimension: Dimension[]): ColorSchemeDefinition;
    ...
    _setClientState(clientState: MapClientState | GridClientState): void;
    ...
    _processItemClientStateUpdate: (itemName: any, clientState: MapClientState | GridClientState) => void;
    _processExpandingStateChanged: (expandingParams: IExpandingState, dxPivotState: PivotState) => void;
