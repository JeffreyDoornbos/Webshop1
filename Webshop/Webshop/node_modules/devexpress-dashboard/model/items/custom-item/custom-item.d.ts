...
export declare class CustomItem extends DataDashboardItem {
    ...
    customMetadata: {};
    constructor(_meta: ICustomItemMetaData, modelJson?: any, serializer?: ModelSerializer);
    _clearBindings(): void;
    ...
    get customBindings(): Array<ICustomItemBinding>;
    get legacyCustomProperties(): Array<ICustomItemProperty>;
    get customInteractivity(): any;
    get _optionsPanelSections(): Array<SectionOptions>;
