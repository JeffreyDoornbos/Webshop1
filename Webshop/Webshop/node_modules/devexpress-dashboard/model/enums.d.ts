...
export declare type CardFormatRuleLayoutElement = 'ActualValue' | 'AbsoluteVariation' | 'PercentVariation' | 'PercentOfTarget' | 'TargetValue' | 'CardName' | 'Title' | 'Subtitle' | 'Indicator' | 'AllElements';
export declare type FormatRuleChartElement = 'Point' | 'LineOrArea';
...
export declare type DataItemNumericFormatType = 'Auto' | 'General' | 'Number' | 'Currency' | 'Scientific' | 'Percent' | 'Custom';
...
export declare type DateTimeGroupInterval = 'Year' | 'Quarter' | 'Month' | 'Day' | 'Hour' | 'Minute' | 'Second' | 'DayOfYear' | 'DayOfWeek' | 'WeekOfYear' | 'WeekOfMonth' | 'MonthYear' | 'QuarterYear' | 'WeekYear' | 'DayMonthYear' | 'DateHour' | 'DateHourMinute' | 'DateHourMinuteSecond' | 'None';
export declare type DateTimeInterval = 'Year' | 'Quarter' | 'Month' | 'Week' | 'Day' | 'Hour' | 'Minute' | 'Second';
...
export declare type DeltaValueType = 'ActualValue' | 'AbsoluteVariation' | 'PercentVariation' | 'PercentOfTarget' | 'TargetValue';
...
export declare type LayoutDimensionMode = 'Auto' | 'Fixed';
...
export declare let getPointLabelContentTypeValues: (val: PointLabelContentType) => Array<PointLabelContentType>;
