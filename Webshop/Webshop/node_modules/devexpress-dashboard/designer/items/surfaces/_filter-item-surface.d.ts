...
export declare class FilterItemSurface extends DataDashboardItemSurface<FilterElementItemBase> {
    fillSections(): void;
    constructor(dashboardItem: FilterElementItemBase, dashboardModel: Dashboard, dataSourceBrowser: DataSourceBrowser, notificationController: NotificationController);
