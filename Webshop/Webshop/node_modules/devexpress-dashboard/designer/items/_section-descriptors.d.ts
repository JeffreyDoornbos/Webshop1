...
export interface ISurfaceConstructor {
    new (dashboardItem: DashboardItem, dashboardModel: Dashboard, dataSourceBrowser: DataSourceBrowser, notificationController: NotificationController): any;
}
export declare class SurfaceItemsFactory {
    ...
    createSurfaceItem<T extends DashboardItem>(dashboardItem: T, dashboardModel: Dashboard, dataSourceBrowser: DataSourceBrowser, notificationController: NotificationController): BaseItemSurface<T>;
}
