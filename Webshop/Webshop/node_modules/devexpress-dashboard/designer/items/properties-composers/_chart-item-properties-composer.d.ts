...
export declare class ChartItemPropertiesComposer extends DashboardItemPropertiesComposer<ChartItem> {
    ...
    constructor(customizeHandler: CustomizeDashboardItemTabs, editCFRuleHandler: (item: ChartItemFormatRule, args: CollectionEditorEditItemArguments, container?: ko.Observable<ChartItemFormatRule>) => void, createCFRuleDelegate: () => ChartItemFormatRule);
