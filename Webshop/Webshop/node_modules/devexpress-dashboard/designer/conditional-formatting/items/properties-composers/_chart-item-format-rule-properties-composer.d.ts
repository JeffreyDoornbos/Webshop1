...
import { FormatRulePropertiesComposer, KeyText } from './_shared-format-rule-properties-composer';
...
export declare function getChartApplyToDataItems(dashboardItem: ChartItem, dataSourceBrowser: DataSourceBrowser): () => KeyText[];
