...
var CanvasManager = (function (_super) {
    ...
    CanvasManager.prototype.onDocumentContextMenu = function (evt) {
        if (!this.viewManager.canvas.parentNode)
            return;
        var parentElement = this.viewManager.canvas.parentElement;
        var rect = parentElement === null || parentElement === void 0 ? void 0 : parentElement.getBoundingClientRect();
        if (rect && !rectangle_1.Rectangle.containsPoint(rect, new point_1.Point(evt.clientX, evt.clientY)))
            return;
