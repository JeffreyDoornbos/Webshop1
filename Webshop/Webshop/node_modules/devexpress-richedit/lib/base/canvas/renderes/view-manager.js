...
var ViewManager = (function () {
    ...
    ViewManager.prototype.ensureFirstPageIsRendered = function () {
        var _a, _b;
        var firstPage = (_b = (_a = this.layout) === null || _a === void 0 ? void 0 : _a.pages) === null || _b === void 0 ? void 0 : _b[0];
        if (!firstPage)
            return;
        if (this.lastUsedRendererType === views_settings_1.ViewType.PrintLayout && !firstPage.flags.get(layout_page_1.LayoutPageFlags.ContentRendered)) {
            ...
            firstPage.flags.set(layout_page_1.LayoutPageFlags.ContentRendered, true);
        }
    };
    return ViewManager;
}());
