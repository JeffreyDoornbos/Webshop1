...
var SimpleViewCanvasSizeManager = (function () {
    function SimpleViewCanvasSizeManager(canvasManager, control) {
        this.id = null;
    ...
    SimpleViewCanvasSizeManager.prototype.changeSizeCore = function () {
        var _this = this;
        {
            list_1.ListUtils.forEach(this.control.viewManager.cache, function (_val) { return _this.control.viewManager.renderer.removePage(1); }, 1);
            ...
            if (this.control.layoutFormatterManager) {
                ...
                this.control.selection.scrollManager.setScroll(new model_states_1.ScrollState().byModelPosition(this.control.selection)
    ...
    DocumentRenderer.prototype.renderBox = function (row, box, noNeedUnderlineAndStrikeout, level) {
        ...
        if (noStrikeoutAndUnderline) {
            ...
            if (needColor && (!needStrikeout || strikeoutColor != color_1.ColorHelper.AUTOMATIC_COLOR))
                content = '<span style="' + commonStyles.join(";") + ';color: ' + color_1.ColorHelper.getCssString(textColor, true) + ';">' + content + '</span>';
            if (needStrikeout) {
                ...
                content = '<span style="' + commonStyles.join(";") + ';text-decoration: line-through;' + strikeoutColorStyle + '">' + content + '</span>';
            }
            if (needUnderline) {
                ...
                content = '<span style="' + commonStyles.join(";") + ';text-decoration: underline;' + underlineColorStyle + '">' + content + '</span>';
            }
        }
        else
