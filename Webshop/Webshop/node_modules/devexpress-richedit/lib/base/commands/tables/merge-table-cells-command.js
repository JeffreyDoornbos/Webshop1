...
var MergeTableCellsCommand = (function (_super) {
    ...
    MergeTableCellsCommand.prototype.isEnabled = function () {
        ...
        return control_1.ControlOptions.isEnabled(this.control.modelManager.richOptions.control.tables) &&
            data.isSquare && (data.numRows > 1 || data.rows[0].cells.length > 1) && _super.prototype.isEnabled.call(this);
    };
