...
var html_utils_1 = require("../../rich-utils/html-utils");
...
var PasteSelectionCommand = (function (_super) {
    ...
    PasteSelectionCommand.prototype.changeModel = function () {
        var elements = html_utils_1.getHTMLElementsFromHtml(this.control.inputController, this.control.inputController.getEditableDocumentContent());
...
var ClipboardHelper = (function () {
    ...
    ClipboardHelper.prototype.insertHtml = function (html) {
        ...
        return new Promise(function (resolve, reject) {
            try {
                _this.control.importHtml(html_utils_1.getHTMLElementsFromHtml(_this.control.inputController, html));
                resolve();
            }
            catch (_a) {
                reject('The clipboard item cannot be inserted.');
...
var InsertHtmlCommand = (function (_super) {
    ...
    InsertHtmlCommand.prototype.executeCore = function (_state, options) {
        var _this = this;
        var elements = html_utils_1.getHTMLElementsFromHtml(this.control.inputController, options.param);
        this.history.addTransaction(function () {
