...
var InputEditorBase = (function () {
    ...
    InputEditorBase.prototype.createHierarchy = function (parent) {
        ...
        this.inputElement.classList.add(exports.INPUT_CLASS_NAME);
...
var DivInputEditor = (function (_super) {
    ...
    DivInputEditor.prototype.createInputElement = function () {
        ...
        if (browser_1.Browser.MacOSMobilePlatform && (Number(browser_1.Browser.PlaformMajorVersion) >= 16
            || browser_1.Browser.Safari && browser_1.Browser.MajorVersion >= 16)) {
        ...
        if (data && !this.isIME) {
            ...
            if (keyCode != EMPTY_KEYCODE) {
                if (this.isProcessShortcut(keyCode) && this.control.shortcutManager.isKnownShortcut(keyCode)) {
                    ...
                    if (keyCode !== key_1.KeyCode.Space || !browser_1.Browser.MacOSMobilePlatform)
                        this.clearInputElement();
                    return true;
                }
            }
...
var InputController = (function () {
    ...
    InputController.prototype.renderSelectionToEditableDocument = function () {
        ...
        var guidLabel = rich_utils_1.RichUtils.getCopyPasteGuidLabel(this.control.getGuidParams());
        var html = this.exporter.getHtmlElementsByInterval(model, model.mainSubDocument, interval, guidLabel);
        if (html.length) {
            html = InputController.getCopyPasteHtmlContentForEditable(html, guidLabel);
            this.exporter.rangeCopy = rangeCopy;
        }
        this.setEditableDocumentContent(html);
        this.selectEditableDocumentContent();
    };
    InputController.getCopyPasteHtmlContentForEditable = function (html, guidLabel) {
        return "<a " + guidLabel + "><span " + guidLabel + "><b style=\"font-weight: normal;\" " + guidLabel + ">" + html + "</b></span></a>";
    };
