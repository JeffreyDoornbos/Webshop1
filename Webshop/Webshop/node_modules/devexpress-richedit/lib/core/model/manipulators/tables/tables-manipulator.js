...
var TablesManipulator = (function (_super) {
    ...
    TablesManipulator.prototype.shiftContent = function (subDocument, cell) {
    ...
    TablesManipulator.prototype.insertRowBelow = function (subDocument, table, rowIndex) {
        new insert_table_row_operation_1.InsertTableRowBelowOperation(this.modelManipulator.modelManager, subDocument).execute(table, rowIndex);
    };
    TablesManipulator.prototype.insertRowAbove = function (subDocument, table, rowIndex) {
        new insert_table_row_operation_1.InsertTableRowAboveOperation(this.modelManipulator.modelManager, subDocument).execute(table, rowIndex);
    };
