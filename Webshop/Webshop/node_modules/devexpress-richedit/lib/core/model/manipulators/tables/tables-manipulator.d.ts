...
export declare class TablesManipulator extends BaseManipulator {
    ...
    shiftContent(subDocument: SubDocument, cell: TableCell): void;
    ...
    insertRowBelow(subDocument: SubDocument, table: Table, rowIndex: number): void;
    insertRowAbove(subDocument: SubDocument, table: Table, rowIndex: number): void;
