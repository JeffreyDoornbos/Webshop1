...
var InsertTableRowOperationBase = (function () {
    ...
    InsertTableRowOperationBase.prototype.insertParagraphs = function (subDocument, insertPosition, patternRow) {
        var patternCells = patternRow.cells;
        var propertyBundles = {};
        for (var i = patternCells.length - 1, patternCell = void 0; patternCell = patternCells[i]; i--) {
            var pos = patternCell.startParagraphPosition.value;
            var patternCellRun = subDocument.getRunByPosition(pos);
            var patternCellParagraph = subDocument.getParagraphByPosition(pos);
            propertyBundles[i] = {
