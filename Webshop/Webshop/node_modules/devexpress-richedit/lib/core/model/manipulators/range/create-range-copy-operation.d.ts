...
export declare class RangeCopy {
    ...
    private readonly numberingListCache;
    private readonly abstractNumberingListCache;
    constructor(model: DocumentModel, addedUselessParagraphMarkInEnd: boolean, abstractNumberingListCache?: Record<number, number>, numberingListCache?: Record<number, number>);
