...
var HashBasedCacheCore = (function () {
    ...
    HashBasedCacheCore.prototype.forEach = function (callback) {
        number_1.NumberMapUtils.forEach(this.hashtable, function (items) { return list_1.ListUtils.forEach(items, callback); });
    };
