...
var History = (function () {
    ...
    History.prototype.addTransaction = function (action, isUnderUndo) {
        if (isUnderUndo === void 0) { isUnderUndo = false; }
        this.beginTransaction();
        action(this);
        this.endTransaction(isUnderUndo);
    };
    History.prototype.endTransaction = function (isUnderUndo) {
        if (isUnderUndo === void 0) { isUnderUndo = false; }
        if (--this.transactionLevel >= 0)
            return;
    ...
    History.prototype.addAndRedo = function (historyItem, isUnderUndo) {
        if (isUnderUndo === void 0) { isUnderUndo = false; }
        this.add(historyItem, isUnderUndo);
        historyItem.redo();
    };
    History.prototype.add = function (historyItem, isUnderUndo) {
        if (isUnderUndo === void 0) { isUnderUndo = false; }
        if (this.transactionLevel >= 0)
    ...
    History.prototype.addInternal = function (historyItem, isUnderUndo) {
