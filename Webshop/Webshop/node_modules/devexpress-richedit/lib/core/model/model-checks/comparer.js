...
var ModelComparer = (function () {
    ...
    ModelComparer.prototype.compareSizeBasedOnScale = function (sourceSize, targetSize, sourceScale) {
        var accuracyX = Math.floor(sourceScale.width / 100) + this.pictureSizeAccuracy;
        var accuracyY = Math.floor(sourceScale.height / 100) + this.pictureSizeAccuracy;
        return this.compareSize(sourceSize, targetSize, accuracyX, accuracyY);
    };
    ModelComparer.prototype.compareSize = function (sourceSize, targetSize, accuracyX, accuracyY) {
