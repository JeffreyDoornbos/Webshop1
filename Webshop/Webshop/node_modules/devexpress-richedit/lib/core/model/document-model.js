...
var sub_document_collection_1 = require("./sub-document-collection");
var DocumentModel = (function () {
    function DocumentModel(modelOptions, subDocumentsIdCounter) {
        ...
        this.subDocumentsCollection = new sub_document_collection_1.SubDocumentCollection();
    ...
    ;
    Object.defineProperty(DocumentModel.prototype, "subDocuments", {
        get: function () {
    ...
    DocumentModel.prototype.setPageColor = function (value) {
    ...
    DocumentModel.prototype.updateHyperlinkFields = function (processor, interval, newSubDocuments) {
        var subDocIntervals = tslib_1.__spreadArray([
            interval
        ], newSubDocuments.map(function (s) { return new sub_document_1.SubDocumentInterval(s, s.interval); }));
        number_1.NumberMapUtils.forEach(subDocIntervals, function (subDocInterval) {
            for (var _i = 0, _a = subDocInterval.subDocument.fields; _i < _a.length; _i++) {
                var field = _a[_i];
                if (subDocInterval.interval.containsInterval(field.getAllFieldInterval())) {
                    var fieldParser = tree_creator_1.FieldsWaitingForUpdate.getParser(processor.modelManager, processor.layoutFormatterManager, processor.createFieldRequestManager(), subDocInterval.subDocument, field);
