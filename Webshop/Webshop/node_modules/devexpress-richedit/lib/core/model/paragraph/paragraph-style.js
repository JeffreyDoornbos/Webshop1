...
var ParagraphStyle = (function (_super) {
    ...
    ParagraphStyle.prototype.isInOwnList = function () {
        return this.numberingListIndex >= 0;
    };
    ParagraphStyle.prototype.getListLevel = function (model) {
        return this.getNumberingList(model).levels[this.getListLevelIndex()];
    };
    ParagraphStyle.prototype.getNumberingList = function (model) {
