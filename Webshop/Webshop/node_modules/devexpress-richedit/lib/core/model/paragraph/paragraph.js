...
var Paragraph = (function () {
    ...
    Paragraph.prototype.isInOwnList = function () {
    ...
    Paragraph.prototype.getParagraphMergedProperties = function () {
        if (!this.mergedParagraphFormatting) {
            ...
            if (this.numberingListIndex == numbering_list_1.AbstractNumberingList.NoNumberingListIndex)
    ...
    Paragraph.prototype.copyFrom = function (from) {
