...
var BoxGenerator = (function () {
    ...
    BoxGenerator.createLayoutAnchoredTextBoxFromRun = function (anchorTextBox, subDocumentId, colorProvider) {
        return new layout_anchored_text_box_1.LayoutAnchoredTextBox(anchorTextBox.getCharacterMergedProperties(), anchorTextBox.getCharacterMergedProperties().getLayoutColorInfo(colorProvider), subDocumentId, anchorTextBox.anchorInfo.clone(), anchorTextBox.shape.clone().applyConverter(unit_converter_1.UnitConverter.twipsToPixelsF), anchorTextBox.anchoredObjectID, unit_converter_1.UnitConverter.twipsToRadians(anchorTextBox.size.rotation), anchorTextBox.subDocId, anchorTextBox.textBoxProperties.clone().setMarginsToAnotherMeasuringSystem(unit_converter_1.UnitConverter.twipsToPixelsF));
    };
    BoxGenerator.prototype.makeAnchoredTextBoxRun = function () {
        ...
        if (anchorTextBox.anchorInfo.hidden)
            return;
        this.modelIterator.charOffset++;
        var textBoxWrap = this.addNewBoxInfo(BoxGenerator.createLayoutAnchoredTextBoxFromRun(anchorTextBox, this.subDocument.id, this.colorProvider));
        if (textBoxWrap)
