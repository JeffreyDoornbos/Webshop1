...
var document_model_1 = require("../../model/document-model");
...
var LayoutRowBoundsCalculator = (function () {
    ...
    LayoutRowBoundsCalculator.prototype.getRectangleBounds = function (manager) {
        ...
        if (!tableFormatter) {
            var ignoreFloatingObjectsInHeaderFooter = manager.model.compatibilitySettings.compatibilityMode < document_model_1.CompatibilityMode.Word2013;
