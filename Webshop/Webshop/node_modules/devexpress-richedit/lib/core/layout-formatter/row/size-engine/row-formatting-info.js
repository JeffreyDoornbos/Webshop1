...
var RowFormattingInfo = (function () {
    ...
    RowFormattingInfo.prototype.findNextYPosWhatHasNeededSpace = function (requiredWidth) {
        while (this.isFloatingIntersectRow && !list_1.ListUtils.anyOf(this.intervals, function (i) { return i.avaliableWidth >= requiredWidth; }))
            this.resetMinY(list_1.ListUtils.min);
        this.currIndex = 0;
    };
