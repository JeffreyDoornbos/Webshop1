...
var FloatingObjectImportInfo = (function () {
    function FloatingObjectImportInfo(data) {
        this.size = new sizes_1.AnchorTextBoxSize(false, 0, new size_1.Size(constants_1.Constants.MIN_SAFE_INTEGER, constants_1.Constants.MIN_SAFE_INTEGER), new size_1.Size(0, 0), enums_1.RelativeWidthType.Page, enums_1.RelativeHeightType.Page, true, true);
        this.imageId = null;
        this.subDocId = -1;
        this.data = data;
