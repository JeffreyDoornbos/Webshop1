...
var DrawingInlineDestination = (function (_super) {
    ...
    DrawingInlineDestination.onCNvGraphicFramePr = function (data, _reader) {
...
var DrawingGraphicFramePropertyDestination = (function (_super) {
    tslib_1.__extends(DrawingGraphicFramePropertyDestination, _super);
    function DrawingGraphicFramePropertyDestination(data, destination) {
        var _this = _super.call(this, data) || this;
        _this.size = destination.floatingObjectImportInfo.size;
        return _this;
    }
    Object.defineProperty(DrawingGraphicFramePropertyDestination.prototype, "elementHandlerTable", {
        get: function () {
    ...
    DrawingGraphicFramePropertyDestination.getThis = function (data) {
        return data.destinationStack.getThis();
    };
    DrawingGraphicFramePropertyDestination.onGraphicFrameLocks = function (data, _reader) {
        return new DrawingGraphicFrameLocksDestination(data, DrawingGraphicFramePropertyDestination.getThis(data));
    };
    DrawingGraphicFramePropertyDestination.handlerTable = new map_creator_1.MapCreator()
        .add('graphicFrameLocks', DrawingGraphicFramePropertyDestination.onGraphicFrameLocks)
        .get();
    return DrawingGraphicFramePropertyDestination;
}(destination_1.ElementDestination));
exports.DrawingGraphicFramePropertyDestination = DrawingGraphicFramePropertyDestination;
